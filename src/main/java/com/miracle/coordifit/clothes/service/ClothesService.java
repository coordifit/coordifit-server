...
public class ClothesService {
    ...
    // ===== 카테고리 조회 =====
    public List<CodeDto> getTopCategories() { return clothesMapper.selectTopCategories(); }
    public List<CodeDto> getChildren(String parentCodeId) { return clothesMapper.selectChildren(parentCodeId); }
    public List<CodeDto> getTree() {
        var parents = clothesMapper.selectTopCategories();
        for (var p : parents) p.setChildren(clothesMapper.selectChildren(p.getCodeId()));
        return parents;
    }
}
